    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            if (Array.isArray(requestPayload)) {
                ...
                const parseGraphQLRequestMark = "parseGraphQLRequest";
                performanceTest.mark(parseGraphQLRequestMark);
                ...
                try {
                    ...
                    performanceTest.measure(processGraphQLRequestMark, processGraphQLRequestMark);
                    ...
                    performanceTest.mark(prettyJSONStringifyMark);
                    body = prettyJSONStringify(serializedGraphqlResponse);
                    performanceTest.measure(prettyJSONStringifyMark, prettyJSONStringifyMark);

                    console.log('>>>> COMPILING MEASUREMENTS');

                    performanceTest.clearMarks();
                }
                catch (error) {
